...
From CircuitsCoqGym Require Import BV. (* Require Export BV. *)
From CircuitsCoqGym Require Import FullAdder. (* Require Export FullAdder. *)
...
forall (v w : BV) (cin : bool), lengthbv v = lengthbv w -> lengthbv (BV_full_adder_sum v w cin) = lengthbv v.
Proof.
...
forall (v w : BV) (cin : bool), BV_full_adder_carry v w cin = BV_full_adder_carry w v cin.
Proof.
  simple induction v. simple induction w. auto. intros.
...
forall (v w : BV) (cin : bool), BV_full_adder v w cin = BV_full_adder w v cin.
Proof.
