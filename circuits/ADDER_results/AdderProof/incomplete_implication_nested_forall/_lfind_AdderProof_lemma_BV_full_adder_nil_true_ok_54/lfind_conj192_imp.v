...
Lemma conj192_imp: forall (l : list bool) (lf7 : BV) (a : bool) (cin0 : bool),
      (not (@eq nat (BV_to_nat (BV_full_adder l lf7 cin0))
        (Nat.add (BV_to_nat l) (bool_to_nat cin0)))) \/
(@eq nat (BV_to_nat (BV_full_adder (@cons bool a l) lf7 true))
