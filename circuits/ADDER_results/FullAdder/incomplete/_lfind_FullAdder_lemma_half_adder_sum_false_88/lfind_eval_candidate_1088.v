...
Lemma candidate_1088: forall (lf3 : bool) (a : bool) (lf5 : bool) (lf6 : bool), @eq bool (orb lf6 (half_adder_carry (half_adder_sum a (orb lf6 true)) false))   (orb lf5 lf3).
Admitted.
QuickChick candidate_1088.