...
Lemma candidate_1129: forall (lf3 : bool) (a : bool) (lf5 : bool), @eq bool   (orb (half_adder_carry a true)      (half_adder_carry (HalfAdder.half_adder_sum true (orb a false)) false))   (orb lf5 lf3).
Admitted.
QuickChick candidate_1129.