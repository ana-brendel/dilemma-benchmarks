...
Lemma candidate_1154: forall (lf3 : bool) (a : bool) (lf5 : bool), @eq bool   (orb (half_adder_carry a (orb a true))      (half_adder_carry (half_adder_sum a (orb a true)) false))    (orb lf5 lf3).
Admitted.
QuickChick candidate_1154.