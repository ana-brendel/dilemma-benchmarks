...
Lemma candidate_1608: forall (lf3 : bool) (a : bool) (lf9 : bool), @eq bool   (orb (half_adder_carry a (orb a true))      (half_adder_carry (half_adder_sum a (orb a true)) lf9))   (orb (half_adder_carry a lf9) lf3).
Admitted.
QuickChick candidate_1608.