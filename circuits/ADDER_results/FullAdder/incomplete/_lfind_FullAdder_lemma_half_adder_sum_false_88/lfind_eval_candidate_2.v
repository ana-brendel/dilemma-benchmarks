...
Lemma candidate_2: forall (a : bool) (lf8 : bool), @eq bool (orb (half_adder_carry a true) (half_adder_carry lf8 false))   (orb (half_adder_carry a false)      (half_adder_carry (half_adder_sum a false) true)).
Admitted.
QuickChick candidate_2.