...
Lemma candidate_2025: forall (lf3 : bool) (a : bool) (lf6 : bool), @eq bool (orb lf6 (half_adder_carry (half_adder_sum a (orb lf6 true)) false))   (orb (half_adder_carry a false) lf3).
Admitted.
QuickChick candidate_2025.