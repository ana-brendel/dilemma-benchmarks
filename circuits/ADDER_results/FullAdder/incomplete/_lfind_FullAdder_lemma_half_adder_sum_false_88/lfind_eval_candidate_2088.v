...
Lemma candidate_2088: forall (lf3 : bool) (a : bool), @eq bool   (orb (half_adder_carry a true)      (half_adder_carry (HalfAdder.half_adder_sum a true) false))   (orb (half_adder_carry a false) lf3).
Admitted.
QuickChick candidate_2088.