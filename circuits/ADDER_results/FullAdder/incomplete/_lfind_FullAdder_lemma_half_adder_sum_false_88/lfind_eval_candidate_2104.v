...
Lemma candidate_2104: forall (lf3 : bool) (a : bool), @eq bool   (orb (half_adder_carry a (orb lf3 true))      (half_adder_carry (half_adder_sum a (orb lf3 true)) false))   (orb (half_adder_carry a false) lf3).
Admitted.
QuickChick candidate_2104.