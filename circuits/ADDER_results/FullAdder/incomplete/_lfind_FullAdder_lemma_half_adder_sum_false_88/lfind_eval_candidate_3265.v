...
Lemma candidate_3265: forall (a : bool) (lf5 : bool) (lf9 : bool), @eq bool   (orb (half_adder_carry a true)      (half_adder_carry (half_adder_sum a true) lf9))   (orb lf5 (HalfAdder.half_adder_sum a false)).
Admitted.
QuickChick candidate_3265.