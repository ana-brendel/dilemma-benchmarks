...
Lemma candidate_3758: forall (lf7 : bool) (lf5 : bool) (lf6 : bool), @eq bool   (orb lf6      (half_adder_carry (HalfAdder.half_adder_sum true (orb lf6 false)) false))   (orb lf5 (half_adder_carry lf7 true)).
Admitted.
QuickChick candidate_3758.