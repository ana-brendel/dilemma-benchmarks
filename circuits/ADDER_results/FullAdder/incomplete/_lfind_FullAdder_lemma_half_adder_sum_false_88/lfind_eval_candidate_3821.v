...
Lemma candidate_3821: forall (a : bool) (lf5 : bool), @eq bool   (orb (half_adder_carry a true)      (half_adder_carry (half_adder_sum a true) false))   (orb lf5 (HalfAdder.half_adder_carry a true)).
Admitted.
QuickChick candidate_3821.