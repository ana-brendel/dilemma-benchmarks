...
Lemma candidate_3823: forall (a : bool) (lf5 : bool), @eq bool   (orb (half_adder_carry a true)      (half_adder_carry (half_adder_sum a true) false))   (orb lf5 (orb a false)).
Admitted.
QuickChick candidate_3823.