...
Lemma candidate_3848: forall (a : bool) (lf7 : bool) (lf5 : bool), @eq bool   (orb (half_adder_carry a (true))      (half_adder_carry (half_adder_sum a (true)) false))   (orb lf5 (half_adder_carry lf7 (true))).
Admitted.
QuickChick candidate_3848.