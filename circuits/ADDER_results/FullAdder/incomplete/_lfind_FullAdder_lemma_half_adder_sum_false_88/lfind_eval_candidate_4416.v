...
Lemma candidate_4416: forall (a : bool) (lf9 : bool), @eq bool   (orb (half_adder_carry a true)      (half_adder_carry (half_adder_sum a true) lf9))   (orb (half_adder_carry a lf9) (orb a false)).
Admitted.
QuickChick candidate_4416.