...
Lemma candidate_4422: forall (a : bool) (lf7 : bool) (lf9 : bool), @eq bool   (orb (half_adder_carry a true)      (half_adder_carry (half_adder_sum a true) lf9))   (orb (lf9) (half_adder_carry lf7 true)).
Admitted.
QuickChick candidate_4422.