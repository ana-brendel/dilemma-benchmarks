...
Lemma candidate_4907: forall (a : bool) (lf8 : bool), @eq bool (orb (half_adder_carry a true) (half_adder_carry lf8 false))   (orb (half_adder_carry a false) (HalfAdder.half_adder_sum lf8 true)).
Admitted.
QuickChick candidate_4907.