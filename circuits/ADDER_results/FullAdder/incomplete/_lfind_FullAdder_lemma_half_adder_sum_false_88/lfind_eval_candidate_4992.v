...
Lemma candidate_4992: forall (a : bool) (lf6 : bool), @eq bool (orb lf6 (half_adder_carry (half_adder_sum a true) false))   (orb (half_adder_carry a false) (orb a false)).
Admitted.
QuickChick candidate_4992.