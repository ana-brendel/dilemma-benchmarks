...
Lemma candidate_5071: forall (a : bool), @eq bool   (orb (half_adder_carry a true)      (half_adder_carry (half_adder_sum a true) false))   (orb (half_adder_carry a false) (orb a a)).
Admitted.
QuickChick candidate_5071.