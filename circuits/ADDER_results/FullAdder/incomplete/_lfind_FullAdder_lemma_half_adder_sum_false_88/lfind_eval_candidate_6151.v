...
Lemma candidate_6151: forall (a : bool) (lf4 : bool), @eq bool (orb (half_adder_carry a true) lf4)   (orb (half_adder_carry a (orb lf4 false))      (half_adder_carry (half_adder_sum a (orb lf4 false)) true)).
Admitted.
QuickChick candidate_6151.