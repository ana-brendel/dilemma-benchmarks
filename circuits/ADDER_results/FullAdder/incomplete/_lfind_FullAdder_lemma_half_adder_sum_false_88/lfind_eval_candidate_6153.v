...
Lemma candidate_6153: forall (a : bool) (lf4 : bool), @eq bool (orb (half_adder_carry a true) lf4)   (orb (half_adder_carry a (lf4))      (half_adder_carry (half_adder_sum a (lf4)) true)).
Admitted.
QuickChick candidate_6153.