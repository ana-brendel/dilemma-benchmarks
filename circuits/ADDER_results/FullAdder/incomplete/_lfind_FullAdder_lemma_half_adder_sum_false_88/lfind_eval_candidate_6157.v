...
Lemma candidate_6157: forall (a : bool) (lf4 : bool), @eq bool (orb (half_adder_carry a true) lf4)   (orb (half_adder_carry a false)      (half_adder_carry (HalfAdder.half_adder_carry a true) true)).
Admitted.
QuickChick candidate_6157.