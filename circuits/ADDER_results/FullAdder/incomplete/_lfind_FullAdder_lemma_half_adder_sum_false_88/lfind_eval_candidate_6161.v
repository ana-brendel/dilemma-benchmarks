...
Lemma candidate_6161: forall (a : bool) (lf4 : bool), @eq bool (orb (HalfAdder.half_adder_sum a lf4) lf4)   (orb (half_adder_carry a false)      (half_adder_carry (half_adder_sum a false) true)).
Admitted.
QuickChick candidate_6161.