...
Lemma candidate_6187: forall (a : bool) (lf4 : bool), @eq bool (orb (half_adder_carry a (orb a true)) lf4)   (orb (half_adder_carry a false)      (half_adder_carry (half_adder_sum a false) (orb a true))).
Admitted.
QuickChick candidate_6187.