...
Lemma candidate_6758: forall (a : bool) (lf5 : bool) (lf9 : bool), @eq bool (orb (orb a false) (half_adder_carry (half_adder_sum a true) lf9))   (orb lf5 (half_adder_carry (half_adder_sum a lf9) true)).
Admitted.
QuickChick candidate_6758.