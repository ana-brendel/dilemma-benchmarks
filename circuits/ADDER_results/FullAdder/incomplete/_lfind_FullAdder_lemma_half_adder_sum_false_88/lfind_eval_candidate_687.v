...
Lemma candidate_687: forall (a : bool), @eq bool (half_adder_sum a true)   (HalfAdder.half_adder_sum true (HalfAdder.half_adder_carry a true)).
Admitted.
QuickChick candidate_687.