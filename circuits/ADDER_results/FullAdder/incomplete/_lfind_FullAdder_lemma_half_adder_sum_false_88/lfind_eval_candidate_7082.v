...
Lemma candidate_7082: forall (a : bool) (lf5 : bool) (lf10 : bool), @eq bool   (orb (half_adder_carry a lf10)      (half_adder_carry (half_adder_sum a lf10) false))   (orb lf5 (half_adder_carry (orb a lf5) lf10)).
Admitted.
QuickChick candidate_7082.