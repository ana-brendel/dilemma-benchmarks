...
Lemma candidate_7248: forall (a : bool) (lf5 : bool), @eq bool (orb (half_adder_carry a true) (HalfAdder.half_adder_sum lf5 false))   (orb lf5 (half_adder_carry (half_adder_sum a false) true)).
Admitted.
QuickChick candidate_7248.