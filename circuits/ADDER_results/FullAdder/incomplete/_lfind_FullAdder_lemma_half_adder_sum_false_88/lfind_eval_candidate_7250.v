...
Lemma candidate_7250: forall (a : bool) (lf5 : bool), @eq bool   (orb (half_adder_carry a true) (HalfAdder.half_adder_carry lf5 false))   (orb lf5 (half_adder_carry (half_adder_sum a false) true)).
Admitted.
QuickChick candidate_7250.