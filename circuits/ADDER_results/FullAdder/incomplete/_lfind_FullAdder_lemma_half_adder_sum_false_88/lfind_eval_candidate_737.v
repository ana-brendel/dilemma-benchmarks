...
Lemma candidate_737: forall (a : bool) (lf9 : bool), @eq bool   (orb (half_adder_carry a true)      (half_adder_carry (half_adder_sum a true) lf9))   (HalfAdder.half_adder_carry a true).
Admitted.
QuickChick candidate_737.