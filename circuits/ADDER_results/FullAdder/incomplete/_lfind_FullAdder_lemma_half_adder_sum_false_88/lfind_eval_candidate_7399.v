...
Lemma candidate_7399: forall (a : bool) (lf5 : bool), @eq bool   (orb (half_adder_carry a true)      (half_adder_carry (half_adder_sum a true) (lf5)))   (orb lf5 (half_adder_carry (half_adder_sum a (lf5)) true)).
Admitted.
QuickChick candidate_7399.