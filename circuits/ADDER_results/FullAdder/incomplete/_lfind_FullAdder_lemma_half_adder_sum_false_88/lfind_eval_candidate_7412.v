...
Lemma candidate_7412: forall (a : bool) (lf5 : bool), @eq bool   (orb (half_adder_carry a true)      (half_adder_carry (half_adder_sum a true) false))   (orb lf5 (half_adder_carry (a) true)).
Admitted.
QuickChick candidate_7412.