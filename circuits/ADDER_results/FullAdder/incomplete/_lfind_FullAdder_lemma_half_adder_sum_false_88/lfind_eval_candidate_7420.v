...
Lemma candidate_7420: forall (a : bool) (lf5 : bool), @eq bool (orb (orb a lf5) (half_adder_carry (half_adder_sum a true) false))   (orb lf5 (half_adder_carry (half_adder_sum a false) true)).
Admitted.
QuickChick candidate_7420.