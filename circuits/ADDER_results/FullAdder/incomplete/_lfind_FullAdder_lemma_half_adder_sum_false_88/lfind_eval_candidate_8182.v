...
Lemma candidate_8182: forall (a : bool) (lf6 : bool), @eq bool (orb lf6 (HalfAdder.half_adder_sum lf6 a))   (orb (half_adder_carry a false)      (half_adder_carry (half_adder_sum a false) true)).
Admitted.
QuickChick candidate_8182.