...
Lemma candidate_959: forall (a : bool) (lf10 : bool), @eq bool   (orb (half_adder_carry a lf10)      (half_adder_carry (half_adder_sum a lf10) false)) (orb a false).
Admitted.
QuickChick candidate_959.