...
Lemma conj3697: forall (lf6 : lst) (lf8 : lst) (lf10 : lst) (l1 : lst) (x : natural) (lf12 : lst) (n : natural), @eq lst
  (lfappend (lfappend (lfappend lf10 lf8) (Cons x (rev l1))) (Cons n lf12))
