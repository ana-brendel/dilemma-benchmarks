...
Lemma lfind_state   (n : natural) (l : lst) : @eq natural (plus (len (rev l)) (len (Cons n Nil))) (Succ (len l)).
Admitted.

From QuickChick Require Import QuickChick.
QCInclude "/home/anabrendel/lfind/benchmarks/clam/sources/_lfind_clam_lf_goal6_len_rev_56_plus_comm/".
QCInclude ".".
