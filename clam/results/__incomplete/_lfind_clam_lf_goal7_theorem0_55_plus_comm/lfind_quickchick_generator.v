...
Lemma lfind_state   (n : natural) (y : lst) (x : lst) : @eq natural (plus (len x) (Succ (Succ (len y))))
  (Succ (Succ (plus (len y) (len x)))).
Admitted.

From QuickChick Require Import QuickChick.
QCInclude "/home/anabrendel/lfind/benchmarks/clam/sources/_lfind_clam_lf_goal7_theorem0_55_plus_comm/".
QCInclude ".".
