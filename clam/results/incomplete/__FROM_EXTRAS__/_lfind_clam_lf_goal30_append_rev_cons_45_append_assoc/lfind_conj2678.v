...
Lemma conj2678: forall (lf8 : lst) (l1 : lst) (x : natural) (lf12 : lst) (n : natural) (lf7 : lst) (l2 : lst), @eq lst (lfappend (lfappend (lfappend (rev l2) lf8) lf7) (Cons n lf12))
  (lfappend (lfappend (rev l2) lf8)
