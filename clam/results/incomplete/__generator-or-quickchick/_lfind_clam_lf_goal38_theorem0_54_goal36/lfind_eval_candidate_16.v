...
Lemma candidate_16: forall (lf3 : bool) (z : lst) (y : lst) (x : natural), forall _ : @eq bool (mem (lfappend y (lfappend y y)) x) lf3, @eq bool (mem (lfappend y z) x) lf3.
Admitted.
QuickChick candidate_16.