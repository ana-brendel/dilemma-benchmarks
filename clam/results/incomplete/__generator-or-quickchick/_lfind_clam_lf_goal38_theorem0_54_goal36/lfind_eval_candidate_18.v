...
Lemma candidate_18: forall (lf3 : bool) (z : lst) (y : lst) (x : natural), forall _ : @eq bool (orb (eqb x (Succ x)) (mem y x)) lf3, @eq bool (mem (lfappend y z) x) lf3.
Admitted.
QuickChick candidate_18.