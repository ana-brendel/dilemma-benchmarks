...
Lemma lfind_state   (l2 : lst) : @eq natural (len l2) (len (lfappend l2 Nil)).
Admitted.

From QuickChick Require Import QuickChick.
QCInclude "/home/anabrendel/lfind/benchmarks/clam/sources/_lfind_clam_lf_goal23_lem_47_lem3/".
QCInclude ".".
