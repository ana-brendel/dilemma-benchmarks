...
Lemma lfind_state   (n : natural) (y : lst) (x : lst) : @eq lst (lfappend (lfappend (qreva y Nil) (qreva x Nil)) (Cons n Nil))
  (lfappend (qreva y Nil) (qreva x (Cons n Nil))).
Admitted.

From QuickChick Require Import QuickChick.
QCInclude "/home/anabrendel/lfind/benchmarks/clam/sources/_lfind_clam_lf_goal31_qreva_append_59_append_assoc/".
QCInclude ".".
