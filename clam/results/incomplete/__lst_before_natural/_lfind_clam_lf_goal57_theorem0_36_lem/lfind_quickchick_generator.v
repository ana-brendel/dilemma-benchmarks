...
Lemma lfind_state   (u : natural) (z : lst) (y : natural) (w : natural) (v : natural) (x : natural) : @eq lst (drop u (drop (Succ v) (drop (Succ w) (Cons x (Cons y z)))))
  (drop (Succ u) (drop v (drop w (Cons x z)))).
Admitted.

From QuickChick Require Import QuickChick.
QCInclude "/home/anabrendel/lfind/benchmarks/clam/sources/_lfind_clam_lf_goal57_theorem0_36_lem/".
QCInclude ".".
