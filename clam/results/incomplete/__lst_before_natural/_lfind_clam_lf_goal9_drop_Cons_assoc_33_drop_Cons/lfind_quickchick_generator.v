...
Lemma lfind_state   (x2 : natural) (n : natural) (l : lst) (x1 : natural) (x3 : natural) : @eq lst (drop x2 (drop (Succ x1) (Cons n l)))
  (drop x1 (drop (Succ x2) (Cons n l))).
Admitted.

From QuickChick Require Import QuickChick.
QCInclude "/home/anabrendel/lfind/benchmarks/clam/sources/_lfind_clam_lf_goal9_drop_Cons_assoc_33_drop_Cons/".
QCInclude ".".
