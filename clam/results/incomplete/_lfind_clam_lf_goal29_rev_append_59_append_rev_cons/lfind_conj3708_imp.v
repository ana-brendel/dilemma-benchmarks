...
Lemma conj3708_imp: forall (lf10 : lst) (l1 : lst) (lf12 : lst) (n : natural) (n0 : natural) (l2 : lst), forall
  _ : @eq lst (rev (lfappend (Cons n l1) l2))
        (lfappend lf10 (rev (Cons n l1))),
@eq lst (lfappend (rev (lfappend l1 (Cons n0 l2))) (Cons n lf12))
  (lfappend (lfappend lf10 (Cons n0 lf12)) (lfappend (rev l1) (Cons n lf12))).
Admitted.
QuickChick conj3708_imp.