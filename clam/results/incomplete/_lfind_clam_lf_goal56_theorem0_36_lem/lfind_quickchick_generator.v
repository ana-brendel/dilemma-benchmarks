...
Lemma lfind_state   (z : lst) (y : natural) (w : natural) (v : natural) (x : natural) : @eq lst (drop v (drop (Succ w) (drop x (Cons y z))))
  (drop v (drop w (drop x z))).
Admitted.

From QuickChick Require Import QuickChick.
QCInclude "/home/anabrendel/lfind/benchmarks/clam/sources/_lfind_clam_lf_goal56_theorem0_36_lem/".
QCInclude ".".
