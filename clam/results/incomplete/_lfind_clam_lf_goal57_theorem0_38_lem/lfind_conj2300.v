...
Lemma conj2300: forall (x : natural) (v : natural) (lf12 : natural) (lf11 : natural) (y : natural) (z : lst) (lf7 : lst) (u : natural), @eq lst (drop u (drop v (drop (Succ lf12) (Cons x (Cons y z)))))
  (drop u (drop lf11 lf7)).
Admitted.
QuickChick conj2300.