...
Lemma conj3324: forall (lf10 : lst) (x : natural) (v : natural) (w : natural) (lf12 : natural) (lf11 : natural) (y : natural) (z : lst) (u : natural), @eq lst (drop u (drop v (drop (Succ lf12) (Cons x (Cons y z)))))
  (drop u (drop lf11 (drop w lf10))).
Admitted.
QuickChick conj3324.