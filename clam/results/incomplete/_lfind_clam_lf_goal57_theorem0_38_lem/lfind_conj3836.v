...
Lemma conj3836: forall (lf10 : lst) (x : natural) (v : natural) (w : natural) (lf12 : natural) (y : natural) (z : lst) (u : natural), @eq lst (drop u (drop v (drop (Succ lf12) (Cons x (Cons y z)))))
  (drop u (drop (Succ v) (drop w lf10))).
Admitted.
QuickChick conj3836.