...
Theorem goal36 : forall (x : natural) (y : lst) (z : lst), mem y x = true -> mem (lfappend y z) x = true.
Proof.
   intros.
   induction y.
   - simpl. destruct H.
...
Theorem goal37 : forall (x : natural) (y : lst) (z : lst), mem z x = true -> mem (lfappend y z) x = true.
Proof.
   intros.
   induction y.
...
Theorem theorem0 : forall (x : natural) (y : lst) (z : lst), mem y x = true \/ mem z x = true -> mem (lfappend y z) x = true.
Proof.
   intros.
   destruct H.
   - 
