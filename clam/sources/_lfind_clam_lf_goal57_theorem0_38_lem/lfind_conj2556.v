...
Lemma conj2556: forall (x : natural) (v : natural) (w : natural) (lf11 : natural) (y : natural) (z : lst) (lf7 : lst) (u : natural), @eq lst (drop u (drop v (drop (Succ (Succ w)) (Cons x (Cons y z)))))
