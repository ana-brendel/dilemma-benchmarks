...
val goal : ((((heap * heap) * heap) * heap) * int) -> bool

val assump_Assumption_4 : ((((heap * heap) * heap) * heap) * int) -> bool

val assump_Assumption_7 : ((((heap * heap) * heap) * heap) * int) -> bool

val assump_Assumption_6 : ((((heap * heap) * heap) * heap) * int) -> bool

val assump_GenVarEq_gv2 : ((((heap * heap) * heap) * heap) * int) -> bool
