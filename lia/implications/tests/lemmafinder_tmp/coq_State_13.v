...
Definition goal (ex : (heap * heap * heap * heap * nat)) : bool := match ex with | (gv1,gv3,h1_1,h1_2,n0) => (prop_to_bool (lia_heap_benchmarks.Definitions.has_leftist_property gv1 = true)) end. 
Definition assump_GenVarEq_gv1 (ex : (heap * heap * heap * heap * nat)) : bool := match ex with | (gv1,gv3,h1_1,h1_2,n0) => (prop_to_bool (lia_heap_benchmarks.Definitions.mergea n0 h1_1 (lia_heap_benchmarks.Definitions.merge h1_2 gv3) = gv1)) end. 
Definition assump_Assumption_4 (ex : (heap * heap * heap * heap * nat)) : bool := match ex with | (gv1,gv3,h1_1,h1_2,n0) => (prop_to_bool (lia_heap_benchmarks.Definitions.has_leftist_property gv3 = true)) end. 
Definition assump_Assumption_7 (ex : (heap * heap * heap * heap * nat)) : bool := match ex with | (gv1,gv3,h1_1,h1_2,n0) => (prop_to_bool (lia_heap_benchmarks.Definitions.has_leftist_property h1_2 = true)) end. 
Definition assump_Assumption_6 (ex : (heap * heap * heap * heap * nat)) : bool := match ex with | (gv1,gv3,h1_1,h1_2,n0) => (prop_to_bool (lia_heap_benchmarks.Definitions.has_leftist_property h1_1 = true)) end. 
...
Extraction "State_13.ml" goal assump_GenVarEq_gv1 assump_Assumption_4 assump_Assumption_7 assump_Assumption_6 definitions_gv4 definitions_gv0 definitions_gv2 definitions_gv1 definitions_gv3.