...
let () = split_for_prop example_set_11 "goal" goal; split_for_prop example_set_11 "assump_Assumption_4" assump_Assumption_4; split_for_prop example_set_11 "assump_Assumption_7" assump_Assumption_7; split_for_prop example_set_11 "assump_GenVarEq_gv0" assump_GenVarEq_gv0; split_for_prop example_set_11 "assump_Assumption_6" assump_Assumption_6