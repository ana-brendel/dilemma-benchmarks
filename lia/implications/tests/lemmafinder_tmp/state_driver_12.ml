...
let () = split_for_prop example_set_12 "goal" goal; split_for_prop example_set_12 "assump_Assumption_4" assump_Assumption_4; split_for_prop example_set_12 "assump_Assumption_7" assump_Assumption_7; split_for_prop example_set_12 "assump_Assumption_6" assump_Assumption_6; split_for_prop example_set_12 "assump_GenVarEq_gv2" assump_GenVarEq_gv2