...
let () = split_for_prop example_set_13 "goal" goal; split_for_prop example_set_13 "assump_GenVarEq_gv1" assump_GenVarEq_gv1; split_for_prop example_set_13 "assump_Assumption_4" assump_Assumption_4; split_for_prop example_set_13 "assump_Assumption_7" assump_Assumption_7; split_for_prop example_set_13 "assump_Assumption_6" assump_Assumption_6