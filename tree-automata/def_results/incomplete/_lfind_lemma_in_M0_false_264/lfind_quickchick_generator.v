...
Lemma lfind_state   (p : prec_list) : not (prec_in_state (M0 prec_list) p).
Admitted.

From QuickChick Require Import QuickChick.
QCInclude "/home/anabrendel/lfind/benchmarks/tree-automata/defs_tests/_lfind_lemma_in_M0_false_264/".
QCInclude ".".
...
Definition collect_data (p : prec_list) :=
 let lfind_var := "p:" ++ "(" ++ show p ++ ")"
 in let lfind_v := print p lfind_var
