...
Lemma lfind_state   (a : ad) (p2 : prec_list) (p : prec_list) (a1 : ad) (a0 : ad) (p3 : prec_list) (p2_1 : prec_list) (p1 : prec_list) (p2_0 : prec_list) (p0 : prec_list) : prec_contained p1 (prec_cons a0 p2_1 p2_0).
Admitted.

From QuickChick Require Import QuickChick.
QCInclude "/home/anabrendel/lfind/benchmarks/tree-automata/defs_tests/_lfind_lemma_prec_c_int1_319/".
QCInclude ".".
...
Definition collect_data (a : ad) (p2 : prec_list) (p : prec_list) (a1 : ad) (a0 : ad) (p3 : prec_list) (p2_1 : prec_list) (p1 : prec_list) (p2_0 : prec_list) (p0 : prec_list) :=
 let lfind_var := "a:" ++ "(" ++ show a ++ ")"++ "|" ++"p2:" ++ "(" ++ show p2 ++ ")"++ "|" ++"p:" ++ "(" ++ show p ++ ")"++ "|" ++"a1:" ++ "(" ++ show a1 ++ ")"++ "|" ++"a0:" ++ "(" ++ show a0 ++ ")"++ "|" ++"p3:" ++ "(" ++ show p3 ++ ")"++ "|" ++"p2_1:" ++ "(" ++ show p2_1 ++ ")"++ "|" ++"p1:" ++ "(" ++ show p1 ++ ")"++ "|" ++"p2_0:" ++ "(" ++ show p2_0 ++ ")"++ "|" ++"p0:" ++ "(" ++ show p0 ++ ")"
 in let lfind_v := print p0 lfind_var
 in lfind_state a p2 p a1 a0 p3 p2_1 p1 p2_0 lfind_v.
