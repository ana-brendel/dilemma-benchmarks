...
Inductive tree : Type :=
| E : tree
| T : color -> tree -> nat -> nat -> tree -> tree.

Definition empty_tree : tree := E.

Fixpoint lookup (default : nat) (x: nat) (t : tree) : nat :=
    match t with
    | E => default
...
Definition balance (rb : color) (t1 : tree) (k : nat) (vk : nat) (t2 : tree) : tree :=
    match rb with
...
Fixpoint ins (x : nat) (vx : nat) (t : tree) : tree :=
    match t with
    | E => T Red E x vx E
...
Definition insert (x : nat) (vx : nat) (t : tree) := make_black (ins x vx t).

Fixpoint elements_tr (t : tree) (acc: list (nat * nat)) : list (nat * nat) :=
    match t with
    | E => acc
    | T _ l k v r => elements_tr l ((k, v) :: elements_tr r acc)
    end.

Definition elements (t : tree) : list (nat * nat) := elements_tr t [].

Fixpoint ForallT (P: nat -> nat -> Prop) (t: tree) : Prop :=
    match t with
    | E => True
...
| BST_E : BST E
| BST_T : forall (c : color) (l : tree) (k : nat) (v : nat) (r : tree),
...
| RB_r: forall (l r : tree) (k : nat) (v : nat) (n : nat),
    RB l Red n ->
    RB r Red n ->
    RB (T Red l k v r) Black n
| RB_b: forall (c : color) (l r : tree) (k : nat) (v : nat) (n : nat),
    RB l Black n ->
    RB r Black n ->
